...
cxxfit <- function(tht, revents, rpoly, tperiod, rinteg0, ihess, ndiv, eps, verbose, nthreads, ffun) {
    .Call(`_ETAS_cxxfit`, tht, revents, rpoly, tperiod, rinteg0, ihess, ndiv, eps, verbose, nthreads, ffun)
}
